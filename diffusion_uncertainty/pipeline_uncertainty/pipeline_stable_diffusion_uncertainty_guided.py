...
class StableDiffusionPipelineUncertainty(DiffusionPipeline, TextualInversionLoaderMixin, LoraLoaderMixin, FromSingleFileMixin):
    r"""
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                if start_step_uc <= i < (start_step_uc + num_steps_uc):
                    ...
                    return_dict=False,)
                    noise_pred: torch.Tensor = get_uncertainty_guided_score_with_percentile(noise_pred, latent_model_input, t, prompt_embeds, self.unet, alpha_hat_t=self.scheduler.alphas_cumprod[t], percentile=percentile, guidance_scale=guidance_scale, model_type='stable-diffusion', lr=lr_i, extra_diffusion_kwargs=extra_diffusion_kwargs)
